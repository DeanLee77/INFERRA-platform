...
from inferra_core._internal.domain.tokens import Token, TokenStringDictionary
from inferra_core._internal.domain.fact_values import FactValue
...
class Node(metaclass=ABCMeta):
    ...
    def refresh_stable_node_id(
        self,
        module_name: Optional[str] = None,
        *,
        context: Optional[node_id_utils.NodeIdContext] = None,
    ) -> str:
        """
        ...
        Args:
            ...
            context: Caller-owned parse collision context. A parser always
                supplies one; omitting it performs a stateless calculation.
