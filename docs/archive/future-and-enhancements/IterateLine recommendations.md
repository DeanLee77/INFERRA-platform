...
```
**Superseded Document Notice - 2026-05-11:** This design recommendation is retained as background only. Iterate behavior, layered memory, graph-first traversal, and production readiness status are now governed by the reconciled Phase 2, Phase 2.5, and Phase 3 plans. Do not treat this document's recommendations as the active backlog.
