...
**Superseded Document Notice - 2026-05-11:** This recommendation memo is superseded by the reconciled Phase 3 plan and the alignment audit. It is retained for historical review context only; current Phase 3 blockers are ontology workflow proof and enriched API evidence.
