...
**Superseded Document Notice - 2026-05-11:** This recommendation memo is superseded by the reconciled Phase 2 and Phase 2.5 plans. It is retained for historical review context only; current blockers and evidence live in `INFERRA_Phase2_Implementation_Plan.md`, `INFERRA_Phase2_5_DependencyMatrix_Bridge_Plan.md`, and the alignment audit.
