...
**Superseded Document Notice - 2026-05-11:** This recommendation memo is superseded by the reconciled Phase 5 plan and the alignment audit. It is retained for historical review context only; Phase 5 Section 7 acceptance boxes must remain evidence-driven and should be converted to `[x]` / `[~]` only after a dedicated Phase 5 acceptance pass.
