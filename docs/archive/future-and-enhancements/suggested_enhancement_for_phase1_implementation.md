...
**Superseded Document Notice - 2026-05-11:** This recommendation memo is superseded by `INFERRA_Phase1_Implementation_Plan.md` and the alignment audit. It is retained for historical review context only; do not use this file as the active Phase 1 backlog.
