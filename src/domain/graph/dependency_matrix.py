...
class DependencyMatrix:
    """
    Deprecated compatibility format for 2D matrix dependency relationships.

    .. deprecated:: Phase 2.5
        Runtime code should use HyperAdjacencyGraph / DependencyGraphPort.
        DependencyMatrix remains only for legacy payload loading, migration
        adapters, and compatibility tests.
    ...
    def __init__(self, dependency_two_dimension_list: Optional[List[List[Any]]] = None):
        ...
        """
        warnings.warn(
            "DependencyMatrix is deprecated for runtime use; use HyperAdjacencyGraph "
            "or DependencyGraphPort instead. Matrix usage is limited to legacy "
